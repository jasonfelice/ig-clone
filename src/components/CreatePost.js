...
export default function CreatePost({
  open, setOpen, username, photo, setWarning,
}) {
      ...
      >
        <Fade in={open}>
          <Box sx={style}>
            ...
            <textarea onChange={(e) => setDescription(e.target.value)} value={description} name="description" placeholder="Write a caption" cols="30" rows="10" />
